...
#Gun deaths in Florida - Example __ FINAL - Bad version
...
plot_title_size = 30          #how big do you want the size of the title font? , default is 10
...
plot_subtitle = "Gun murders before and after stand your ground"  #subtitle of plot
